...
$lang = array_merge($lang, array(
	...
	'ALLOW_UNSOLVE'				=> 'Разрешить вновь открывать решённые темы',
	'ALLOW_UNSOLVE_EXPLAIN'		=> 'Дать пользователю или модератору отмечать тему нерешенной. Модераторы могут отмечать темы как нерешённые даже в случае если обе опции выставлены в состояние "Да".',
	...
	'FORUM_SOLVE_COLOR'			=> 'Цвет для текста',
	'FORUM_SOLVE_COLOR_EXPLAIN'	=> 'Выберите цвет для текста. Для выбора цвета по умолчанию оставьте поле пустым.',
