...
$lang = array_merge($lang, array(
	...
	'LOCK_SOLVED_EXPLAIN'		=> 'Bitte beachten Sie, das nur Moderatoren gesperrte Themen wieder entsperren können.',
	'TOPIC_SOLVED_SETTINGS'		=> 'Einstellungen zu "Thema gelöst"',
	'FORUM_SOLVE_TEXT'		=> 'Verwende Text anstelle der Gelöst-Grafik',
	'FORUM_SOLVE_TEXT_EXPLAIN'	=> 'Sie können einen kurzen Text eingeben, der anstelle der Gelöst-Grafik angezeigt wird. Als Beispiel etwa [GELÖST] oder [VERKAUFT] oder ähnliches. Lassen Sie dieses Feld leer, wenn die Gelöst-Grafik angezeigt werden soll.',
	'FORUM_SOLVE_COLOUR'		=> 'Textfarbe',
	'FORUM_SOLVE_COLOUR_EXPLAIN'	=> 'Wählen Sie eine Farbe für den Text. Lassen Sie dieses Feld leer, wenn die Standard Farbe verwendet werden soll.',
